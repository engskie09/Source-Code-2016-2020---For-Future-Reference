							...
							<div className = 'modal-dialog'>
								<div className = 'modal-content'>
									<div className = 'modal-header'>
										<h5 className = 'modal-title'>Organogram</h5>
									</div>
									...
									<div ref = { this.Element['Node_Dialog_Footer'] } className = 'modal-footer'>
										<button ref = { this.Element['Node_button_Save'] } type = 'button' className = 'btn btn-outline-theme'>Save changes</button>
										<button type = 'button' className = 'btn btn-outline-theme' data-dismiss = 'modal'>Close</button>
									</div>
								</div>
							</div>
						</div>
