    ...
    public partial class CustomerSession1_Main_ : Form
    {
        ...
        */
        ...
        private void btnCheckin_Click(object sender, EventArgs e)
        {
            ...
            {
                CustomerSession1_Main__DialogShowCheckinValidation navigate = new CustomerSession1_Main__DialogShowCheckinValidation();
                navigate.ShowDialog();               
            }
        ...
        private void btnCheckout_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("You have not check in bobo!");
            }
