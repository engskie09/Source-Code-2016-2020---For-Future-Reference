...
import os, collections, json, simplejson, pymysql, smtplib, ssl, requests, random
...
GLOBAL	=	{
				...
				'Cooperative_OperationArea_Counter_Code'			:	'COOP-OA',
				'Cooperative_CommonBond_Counter_Code'				:	'COOP-CB',
				'Cooperative_Capitalization_Counter_Code'			:	'COOP-CPTLZTN',

				'Philippines_Organization_Counter_Code'				:	'PH-ORG',
...
class Main(object):
	...
	def set_PyMySQL_Connection():
		...
		GLOBAL['PyMySQL_Connection'] = pymysql.connect('127.0.0.1', 'root', '', 'UB_ECIMS', cursorclass = pymysql.cursors.DictCursor, client_flag = CLIENT.MULTI_STATEMENTS)
		GLOBAL['PyMySQL_Cursor'] = GLOBAL['PyMySQL_Connection'].cursor(pymysql.cursors.DictCursor)

	def set_Flask(set_Method):
	...
	def set_Email_Message(set_Sender, set_Receiver, set_Subject, set_Message):
		...
		#get_Credential = ['programmingislife2020@gmail.com', 'programming<3']
		get_Credential = ['paengkokoy@gmail.com', 'youtuber09']
	...
	def set_ShortMessageService_Message(set_Sender, set_Receiver, set_Subject, set_Message):
		...
		get_Object = {}
		get_Object['mocean-api-key'] = '8ddc5c01'
		get_Object['mocean-api-secret'] = '9f66e0cd'
