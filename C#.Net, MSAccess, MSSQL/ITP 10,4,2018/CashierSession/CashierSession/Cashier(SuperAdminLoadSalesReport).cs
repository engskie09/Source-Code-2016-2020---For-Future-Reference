...
{
    public partial class Cashier_SuperAdminSalesReport_ : Form
    {
        MySqlConnection connection = new MySqlConnection(methods.con);

        public Cashier_SuperAdminSalesReport_()
        {
            InitializeComponent();
        }

        private void Cashier_SuperAdminSalesReport__Load(object sender, EventArgs e)
        {
