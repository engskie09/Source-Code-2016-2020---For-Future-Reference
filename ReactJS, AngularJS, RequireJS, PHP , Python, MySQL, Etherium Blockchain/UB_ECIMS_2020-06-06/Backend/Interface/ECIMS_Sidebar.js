		...
		constructor()
		{
			...
			this.state =
			{
				...
				[
					...
					{ 'File_Path' : '../Data/System/Image/Background/UB_ECIMS_Background_1.png', 'File_Name' : 'UB_ECIMS_Background_1'}
				]
			}
		}
									...
									<li className = 'navigation__sub'>
										...
										<ul>
...

											{
												...
												?
												<li>
													<NavLink to = '/Cooperative/Associated' activeClassName = 'navigation__active'>
														&nbsp;Associated
														<span className = 'zwicon-git-pull'></span>
													</NavLink>
												</li>
												:
												<div></div>
