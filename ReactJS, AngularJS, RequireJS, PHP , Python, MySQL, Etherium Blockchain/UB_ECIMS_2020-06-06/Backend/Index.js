	...
	) =>
{
	...
	([
		...
		'jsx!Interface/ECIMS_Cooperative_EconomicSurvey',
		'jsx!Interface/ECIMS_Cooperative_List',
		'jsx!Interface/ECIMS_Cooperative_Manage',
	...
	], () =>
	{
		...
		([
			...
			'ECIMS_Blockchain',
			'ECIMS_Cooperative',
			'ECIMS_Cooperative_EconomicSurvey',
			'ECIMS_Cooperative_List',
			'ECIMS_Cooperative_Manage',
			'ECIMS_Cooperator',
