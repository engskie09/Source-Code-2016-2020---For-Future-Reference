...
namespace SadSignTypicalReservationSystem
{
    class SystemMethodsCustomer
    {
        ...
        //setTableName
        public static String tblname1 = "customersession2_checkin";
        public static String tblname2 = "customersession4_myaccount";
        ...
        public static void insert_CustomerCheckinInformation(String getCustomerFirstname, String getCustomerMiddlename, String getCustomerLastname,
                                                  ...
                                                  String getFloorno, Int32 getRoomAmount)
        {
            MySqlConnection connection = new MySqlConnection(MySqlConnectionString);
            MySqlCommand cmd = new MySqlCommand();
            String cmdQuerysetColumns = "INSERT INTO " + tblname1 + " (CustomerFirstname, CustomerMiddlename ,CustomerLastname, CustomerID, CustomerGender, CustomerCheckinDate, CustomerCheckoutDate, CustomerLengthofstay, CustomerRoomNo, CustomerRoomType, CustomerFloorNo, CustomerRoomAmount)";
            String cmdQuerysetValues = "VALUES (@a1, @a2, @a3, @a4, @a5, @a6, @a7, @a8, @a9, @a10, @a11, @a12)";
