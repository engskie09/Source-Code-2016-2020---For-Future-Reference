...
namespace MythicalCafe_ICMS_BackEnd
{
    public static class MythicalCafe_Control_Propety
    {
        ...
        */
        ...
        public static void get_TextBox_KeyPress_Number_And_Letter(String gettxtString, object sender, KeyPressEventArgs e)
        {
            if (gettxtString == String.Empty)
            {
        ...
        static void get_TextBox_Character_Password_Enter(Object set_Object, EventArgs e)
        {
            BunifuMetroTextbox get_BunifuMetroTextbox = (BunifuMetroTextbox)set_Object;

            get_BunifuMetroTextbox.isPassword = true;
        }

        static void get_TextBox_Character_Password_Leave(Object set_Object, EventArgs e)
        { 
            BunifuMetroTextbox get_BunifuMetroTextbox = (BunifuMetroTextbox)set_Object;

            if (String.IsNullOrEmpty(get_BunifuMetroTextbox.Text.Trim()))
            {
                get_BunifuMetroTextbox.isPassword = false;
            }
        }        
        ...
        */
        ...
        public static void set_TextBox_Character_Password(BunifuMetroTextbox set_BunifuMetroTextbox)
        {
            set_BunifuMetroTextbox.Enter += get_TextBox_Character_Password_Enter;
            set_BunifuMetroTextbox.Leave += get_TextBox_Character_Password_Leave;
        }
