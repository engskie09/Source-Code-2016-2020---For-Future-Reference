...
namespace iTalk
{
    ...
    class iTalk_Button_1 : Control
    {
        ...
        public iTalk_Button_1()
        {
            ...
            P1 = new Pen(Color.FromArgb(150, 34, 57)); // P1 = Border color
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(233, 34, 57), Color.FromArgb(233, 34, 57), 90f);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(150, 34, 57), Color.FromArgb(150, 34, 57), 90f);
                PressedContourGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(233, 34, 57), Color.FromArgb(233, 34, 57), 90f);
    ...
    class iTalk_Button_2 : Control
    {
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(44, 62, 80), Color.FromArgb(44, 62, 80), 90f);
    ...
    class iTalk_TextBox_Big : Control
    {
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (iTalkTB != null)
                {
                    ...
                    if (value)
                    {
                        iTalkTB.Height = Height - 16;
                    }
                    else
                    {
                        Height = iTalkTB.Height + 16;
                    }
                }
        ...
        public Image Image
        {
            ...
            set
            {
                ...
                {
                    iTalkTB.Location = new Point(35, 8);
                }
                Invalidate();
            }
        }
        ...
        public iTalk_TextBox_Big()
        {
            ...
            P1 = new Pen(Color.FromArgb(230, 230, 230)); // P1 = Border color
            P3 = new Pen(Color.Gray);
            B1 = new SolidBrush(Color.FromArgb(230, 230, 230)); // B1 = Rect Background color
            BackColor = Color.Transparent;
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            e.Graphics.DrawImage((Image)B.Clone(), 0, 0);
            e.Graphics.DrawLine(P3, 28, 23, 28, 9);
            G.Dispose();
            B.Dispose();
        }
    }
    ...
    class iTalk_TextBox_Small : Control
    {
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (iTalkTB != null)
                {
                    ...
                    if (value)
                    {
                        iTalkTB.Height = Height - 18;
                    }
                    else
                    {
                        Height = iTalkTB.Height + 18;
                    }
                }
            }
        }
        ...
        {
            var _TB = iTalkTB;
            _TB.Size = new Size(Width - 10, 50);
            _TB.Location = new Point(30, 5);
            _TB.Text = string.Empty;
            _TB.BorderStyle = BorderStyle.None;
            _TB.TextAlign = HorizontalAlignment.Left;
            ...
            _TB.UseSystemPasswordChar = UseSystemPasswordChar;
            _TB.Multiline = false;
            iTalkTB.BackColor = Color.FromArgb(230, 230, 230);
            iTalkTB.KeyDown += _OnKeyDown;
    ...
    public class iTalk_RichTextBox : Control
    {
        ...
        {
            var _RTB = iTalkRTB;
            _RTB.BackColor = Color.FromArgb(240, 240, 240);
            _RTB.Size = new Size(Width - 10, 100);
            _RTB.Location = new Point(7, 5);
            _RTB.Text = string.Empty;
            _RTB.BorderStyle = BorderStyle.None;
            _RTB.Font = new Font("Verdana", 8);
            _RTB.Multiline = true;
            _RTB.MaxLength = 60;
            _RTB.SelectAll();
            _RTB.SelectionAlignment = HorizontalAlignment.Center;
            _RTB.DeselectAll();
        }
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(solidBrush, this.Shape);
            G.DrawPath(new Pen(Color.FromArgb(240, 240, 240)), this.Shape);
            G.Dispose();
            e.Graphics.DrawImage((Image)B.Clone(), 0, 0);
            B.Dispose();
        }
    ...
    class iTalk_Panel : ContainerControl
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.Clear(Color.Transparent);
            SolidBrush solidBrush = new SolidBrush(ColorBox);
            G.FillPath(solidBrush, Shape); // Draw RTB background
            G.DrawPath(new Pen(ColorBorder), Shape); // Draw border
    ...
    public class iTalk_GroupBox : ContainerControl
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            Bitmap B = new Bitmap(Width, Height);
            Graphics G = Graphics.FromImage(B);
            Rectangle TitleBox = new Rectangle(Width / 2 - (Width - 50) / 2, 3, Width - 50, 18);
            ...
            G.FillPath(Brush, RoundRectangle.RoundRect(new Rectangle(1, 12, Width - 3, box.Height - 1), 8));
            // Draw the border of the GroupBox
            G.DrawPath(new Pen(Color.FromArgb(52, 152, 219)), RoundRectangle.RoundRect(new Rectangle(1, 12, Width - 3, Height - 13), 8));

            // Draw the background of the title box
            G.FillPath(new SolidBrush(Color.FromArgb(52, 152, 219)), RoundRectangle.RoundRect(TitleBox, 1));
            ...
            G.DrawString(Text, new Font("Century Gothic", 11, FontStyle.Regular), new SolidBrush(Color.FromArgb(255, 255, 255)), TitleBox, new StringFormat
            {
                Alignment = StringAlignment.Center,
                LineAlignment = StringAlignment.Center
            });
    ...
    public class iTalk_CheckBox : Control
    {
        ...
        private LinearGradientBrush GBChecked;
        private Rectangle R1;
        ...
        protected override void OnResize(System.EventArgs e)
        {
            if (Width > 0 && Height > 0)
            {
                ...
                GB = new LinearGradientBrush(new Rectangle(0, 0, 25, 25), Color.FromArgb(230, 230, 230), Color.FromArgb(230, 230, 230), 90);

                GBChecked = new LinearGradientBrush(new Rectangle(0, 0, 25, 25), Color.FromArgb(32, 32, 32), Color.FromArgb(32, 32, 32), 90);
                var _Shape = Shape;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var _G = e.Graphics;
            _G.Clear(Color.FromArgb(233, 34, 57));
            _G.SmoothingMode = SmoothingMode.AntiAlias;
            // Fill the body of the CheckBox
            _G.FillPath(GB, Shape);
            // Draw the border
            _G.DrawPath(new Pen(Color.FromArgb(230, 230, 230)), Shape);
            // Draw the string
            _G.DrawString(Text, Font, new SolidBrush(Color.Silver), R1, new StringFormat { LineAlignment = StringAlignment.Center });

            if (Checked)
            {
                _G.FillPath(GBChecked, Shape);
                // Draw the border
                _G.DrawPath(new Pen(Color.White), Shape);
                // _G.DrawString("•", new Font("Verdana", 10), new SolidBrush(Color.FromArgb(32, 32, 32)), new Rectangle(2, 0, Width, Height), new StringFormat { LineAlignment = StringAlignment.Center });
            }
            e.Dispose();
        }
    }
    ...
    class iTalk_ComboBox : ComboBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            LGB = new LinearGradientBrush(ClientRectangle, Color.FromArgb(192, 57, 43), Color.FromArgb(192, 57, 43), 90f);
            ...
            e.Graphics.DrawPath(new Pen(Color.FromArgb(192, 57, 43)), GP);
            // Draw string
            e.Graphics.DrawString(Text, Font, new SolidBrush(Color.White), new Rectangle(3, 0, Width - 20, Height), new StringFormat
            {
                LineAlignment = StringAlignment.Center,
            ...
            e.Graphics.DrawLine(new Pen(Color.FromArgb(32,32,32), 2), new Point(Width - 18, 10), new Point(Width - 14, 14));
            e.Graphics.DrawLine(new Pen(Color.FromArgb(32, 32, 32), 2), new Point(Width - 14, 14), new Point(Width - 10, 10));
            e.Graphics.DrawLine(new Pen(Color.FromArgb(32, 32, 32)), new Point(Width - 14, 15), new Point(Width - 14, 14));
    ...
    public class iTalk_ProgressBar : Control
    {
        ...
        private Color _ProgressColor1 = Color.FromArgb(0, 168, 255);
        private Color _ProgressColor2 = Color.FromArgb(0, 168, 255);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Bitmap bitmap = new Bitmap(this.Width, this.Height))
            {
                using (Graphics graphics = Graphics.FromImage(bitmap))
                {
                    ...
                    using (LinearGradientBrush brush2 = new LinearGradientBrush(this.ClientRectangle, Color.FromArgb(15, 15, 15), Color.FromArgb(15, 15, 15), LinearGradientMode.Vertical))
                    {
    ...
    class iTalk_ProgressIndicator : Control
    {
        ...
        private readonly SolidBrush BaseColor = new SolidBrush(Color.FromArgb(192, 57, 43));
        private readonly SolidBrush AnimationColor = new SolidBrush(Color.FromArgb(32, 32, 32));
    ...
    public class iTalk_TabControl : TabControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _Graphics.Clear(Color.FromArgb(45, 45, 48));
            ...
            _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(40,40,40)), new Rectangle(-5, 0, ItemSize.Height + 4, Height));
            ...
            for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
            {
                if (TabIndex == SelectedIndex)
                {
                    ...
                    _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(32, 32, 32)), TabRect.X, TabRect.Y, TabRect.Width - 4, TabRect.Height + 3);
                    ...
                    _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(192, 57, 43)), TabHighlighter);
                    // Draw tab text
                    _Graphics.DrawString(TabPages[TabIndex].Text, new Font(new FontFamily("Century Gothic"), 8, FontStyle.Regular), new SolidBrush(Color.FromArgb(254, 255, 255)), new Rectangle(TabRect.Left + 40, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), new StringFormat { Alignment = StringAlignment.Near });
                ...
                {
                    Rectangle TabRect = new Rectangle(new Point(GetTabRect(TabIndex).Location.X - 2, GetTabRect(TabIndex).Location.Y - 2), new Size(GetTabRect(TabIndex).Width + 3, GetTabRect(TabIndex).Height - 8));
                    _Graphics.DrawString(TabPages[TabIndex].Text, new Font(new FontFamily("Century Gothic"), 8, FontStyle.Regular), new SolidBrush(Color.FromArgb(159, 162, 167)), new Rectangle(TabRect.Left + 40, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), new StringFormat { Alignment = StringAlignment.Near });
    ...
    public class iTalk_TrackBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            base.OnPaint(e);
            Graphics G = e.Graphics;
            HatchBrush Hatch = new HatchBrush(HatchStyle.WideDownwardDiagonal, Color.FromArgb(50,50,50), Color.Transparent);
            G.Clear(Parent.BackColor);
            G.SmoothingMode = SmoothingMode.AntiAlias;
            checked
            {
                ...
                this.VlaueLGB = new LinearGradientBrush(this.ValueRect, Color.FromArgb(192, 57, 43), Color.FromArgb(192, 57, 43), 90f);
                ...
                G.ResetClip();
                G.SmoothingMode = SmoothingMode.AntiAlias;
                G.DrawPath(new Pen(Color.FromArgb(192, 57, 43)), this.PipeBorder);
                this.TrackBarHandle = RoundRectangle.RoundRect(this.TrackBarHandleRect, 3);
                this.TrackBarHandleLGB = new LinearGradientBrush(this.ClientRectangle, Color.FromArgb(192, 57, 43), Color.FromArgb(192, 57, 43), 90f);
                G.FillPath(this.TrackBarHandleLGB, this.TrackBarHandle);
                G.DrawPath(new Pen(Color.FromArgb(192, 57, 43)), this.TrackBarHandle);

                if (_DrawValueString == true)
                {
                    G.DrawString(System.Convert.ToString(ValueToSet), Font, Brushes.Purple, 0, 25);
                }
            }
        }
    }
    ...
    [DefaultEvent("ValueChanged")]
    public class ExperienceBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            base.OnPaint(e);
            Graphics G = e.Graphics;
            HatchBrush Hatch = new HatchBrush(HatchStyle.WideDownwardDiagonal, Color.FromArgb(32, 32, 32), Color.Transparent);
            G.Clear(Parent.BackColor);
            G.SmoothingMode = SmoothingMode.AntiAlias;
            checked
            {
                ...
                this.TrackBarHandleRect = new Rectangle(this.ValueDrawer, 0, 0, 0);
                G.SetClip(this.PipeBorder);
                if (_Value == 0)
                {
                    this.ValueRect = new Rectangle(1, 7, this.TrackBarHandleRect.X + this.TrackBarHandleRect.Width -2, 7);
                ...
                {
                    this.ValueRect = new Rectangle(1, 7, this.TrackBarHandleRect.X + this.TrackBarHandleRect.Width + 7, 7);
                }
                this.VlaueLGB = new LinearGradientBrush(this.ValueRect, Color.FromArgb(0, 168, 255), Color.FromArgb(0, 168, 255), 90f);
                G.FillRectangle(this.VlaueLGB, this.ValueRect);
                ...
                G.ResetClip();
                G.SmoothingMode = SmoothingMode.AntiAlias;
                G.DrawPath(new Pen(Color.FromArgb(0, 168, 255)), this.PipeBorder);
                this.TrackBarHandle = RoundRectangle.RoundRect(this.TrackBarHandleRect, 3);
                this.TrackBarHandleLGB = new LinearGradientBrush(this.ClientRectangle, Color.FromArgb(0, 168, 255), Color.FromArgb(0, 168, 255), 90f);
                //G.FillPath(this.TrackBarHandleLGB, this.TrackBarHandle);
               // G.DrawPath(new Pen(Color.FromArgb(192, 57, 43)), this.TrackBarHandle);

                if (_DrawValueString == true)
                {
                    //percentage = (_Value / _Maximum) * 100;
                    //G.DrawString(percentage.ToString() + "%", Font, Brushes.White, this.Width / 2 - 8, 17);
                }
            }
        }
    }
    #region CustomizedProgressBar

    [DefaultEvent("ValueChanged")]
    public class customizedProgressBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            base.OnPaint(e);
            Graphics G = e.Graphics;
            HatchBrush Hatch = new HatchBrush(HatchStyle.WideDownwardDiagonal, Color.FromArgb(233, 34, 57), Color.Transparent);
            G.Clear(Parent.BackColor);
            G.SmoothingMode = SmoothingMode.AntiAlias;
            checked
            {
                this.PipeBorder = RoundRectangle.RoundRect(1, 6, this.Width - 3, 15, 3);
                try
                {
                    this.ValueDrawer = (int)Math.Round(unchecked(checked((double)(this._Value - this._Minimum) / (double)(this._Maximum - this._Minimum)) * (double)checked(this.Width - 11)));
                }
                ...
                if (_Value == 0)
                {
                    this.ValueRect = new Rectangle(1, 7, this.TrackBarHandleRect.X + this.TrackBarHandleRect.Width -2, 14);
                }
                else
                {
                    this.ValueRect = new Rectangle(1, 7, this.TrackBarHandleRect.X + this.TrackBarHandleRect.Width + 7, 14);
                }
                this.VlaueLGB = new LinearGradientBrush(this.ValueRect, Color.White, Color.White, 90f);
                G.FillRectangle(this.VlaueLGB, this.ValueRect);
                ...
                G.ResetClip();
                G.SmoothingMode = SmoothingMode.AntiAlias;
                G.DrawPath(new Pen(Color.White), this.PipeBorder);
                this.TrackBarHandle = RoundRectangle.RoundRect(this.TrackBarHandleRect, 3);
                this.TrackBarHandleLGB = new LinearGradientBrush(this.ClientRectangle, Color.White, Color.White, 90f);
                //G.FillPath(this.TrackBarHandleLGB, this.TrackBarHandle);
               // G.DrawPath(new Pen(Color.FromArgb(192, 57, 43)), this.TrackBarHandle);
