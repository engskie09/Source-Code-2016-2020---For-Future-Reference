...
namespace engskie09ApartmentSystem
{
    class SystemMethodsGeneral
    {
        ...
        public static void getStaffID()
        {
            ...
            cmd = connection.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT increment_current from " + tblname3 + " WHERE increment_name = 'user_Staff'";
            cmd.ExecuteNonQuery();
            ...
            increment = 1 + Convert.ToInt32(dr["increment_current"].ToString());
            getStaff_ID = "100-" + increment;
            connection.Close();

        }

        public static void updateStaffID()
        {
            dt.Rows.Clear();
            dt.Columns.Clear();
            increment = 0;
            ...
            //MessageBox.Show(increment.ToString());
            cmd.CommandText = "UPDATE " + tblname3 + " SET increment_current = '" + increment + "' WHERE increment_name = 'user_Staff' ";
            cmd.ExecuteNonQuery();
            connection.Close();
        }
