...
namespace Pagawa_SarisariStoreOrderingSystem_
{
    public partial class Bili2xNakayo : Form
    {
        ...
        OleDbConnection connectionXD = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\server\Documents\Visual Studio 2012\Projects\Pagawa(SarisariStoreOrderingSystem)\Pagawa(SarisariStoreOrderingSystem)\Pagawa(SarisariStoreOrderingSystem)database.accdb");
        ...
        public void notoOvernightxD()
        {
            ...
            for (int x = 0; x <= productsDATAGRIDVIEWsale.Rows.Count - 1; x++)
            {
                ...
                cmd.CommandText = "SELECT * FROM ProductsInfo Where Product_Name='" + EZxD[x].ToString() + "'";
                cmd.ExecuteNonQuery();
                ...
                cmd.CommandText = "UPDATE ProductsInfo Set Product_Sold= '" + a.ToString() + "' Where Product_Name= '" + EZxD[x].ToString() + "'";
                cmd.ExecuteNonQuery();
            }
            connectionXD.Close();
        }
       ...
       */
        ...
        public void updateQuantity()
        {
            ...
            for (int x = 0; x <= productsDATAGRIDVIEWsale.Rows.Count - 1; x++)
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show(EZxD[x].ToString() + EZxPorigFinal[x].ToString());
       ...
       */
        ...
        private void removefromCart_Click(object sender, EventArgs e)
        {
            try
            {
                MessageBox.Show(EZxPorig.ToString());
