...
{
    public partial class MythicalCafe_BackEnd_Account_Manage_List_Property_Information_Time : Form
    {
        public MythicalCafe_BackEnd_Account_Manage_List_Property_Information_Time()
        {
            InitializeComponent();
        }

        private void MythicalCafe_BackEnd_UserControl_Workstation_Time_Bonus_Load(object sender, EventArgs e)
        {
        ...
        void MythicalCafe_BackEnd_UserControl_Workstation_Time_Bonus_FormClosed(object sender, FormClosedEventArgs e)
        {
